 ...
 * @author arias
 */
@WebServlet(name = "EliminarFormaDePagoServlet", urlPatterns = {"/EliminarFormaDePagoServlet"})
public class EliminarFormaDePagoServlet extends HttpServlet {
